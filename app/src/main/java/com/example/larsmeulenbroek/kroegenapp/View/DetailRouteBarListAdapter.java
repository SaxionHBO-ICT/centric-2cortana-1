...
/**
 * Created by Lars Meulenbroek on 6/21/2016.
 */
public class DetailRouteBarListAdapter extends ArrayAdapter<Bar> {

    private int bar_id;
    private List<Bar> routeBarList;

    public DetailRouteBarListAdapter(Context context, int resource, List<Bar> objects) {
        super(context, resource, objects);
        this.routeBarList = objects;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Bar currentBar = routeBarList.get(position);
